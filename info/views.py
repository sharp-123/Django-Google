...
def instagram(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/instagram.html', {'att_list': att_list})
...
@login_required()
def attendance_search(request, stud_id):
    flg = True
    stud = Student.objects.get(USN=stud_id)
    ass_list = Assign.objects.filter(class_id_id=stud.class_id)
    att_list = []
    ...
    searches_items = data.get('hashtag')
    count = data.get('amount')
    delay = 0
    req_delay = None
...
def linkedin(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/linkedin.html', {'att_list': att_list})


@login_required()
def tiktok(request, stud_id):
    stud = Student.objects.get(USN=stud_id)
    ass_list = Assign.objects.filter(class_id_id=stud.class_id)
    att_list = []
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/tiktok.html', {'att_list': att_list})


@login_required()
def youtube(request, stud_id):
    stud = Student.objects.get(USN=stud_id)
    ass_list = Assign.objects.filter(class_id_id=stud.class_id)
    att_list = []
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/youtube.html', {'att_list': att_list})


@login_required()
def twitter(request, stud_id):
    stud = Student.objects.get(USN=stud_id)
    ass_list = Assign.objects.filter(class_id_id=stud.class_id)
    att_list = []
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/twitter.html', {'att_list': att_list})
