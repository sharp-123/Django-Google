...
urlpatterns = [
    ...
    path('student/<slug:stud_id>/instagram/',
         views.instagram, name='instagram'),
    ...
    path('student/<slug:stud_id>/tiktok/',
         views.tiktok, name='tiktok'),
    path('student/<slug:stud_id>/youtube/',
         views.youtube, name='youtube'),
    path('student/<slug:stud_id>/twitter/',
         views.twitter, name='twitter'),
