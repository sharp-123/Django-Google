# Generated by Django 3.2.16 on 2023-01-26 17:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('Instagram', 'Instagram'), ('Facebook', 'Facebook'), ('LinkedIn', 'LinkedIn'), ('TikTok', 'TikTok'), ('Youtube', 'Youtube'), ('Twitter', 'Twitter')], max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.process', verbose_name='the related Process')),
            ],
        ),
        migrations.AddField(
            model_name='course',
